...
module top ;
	...
	wire [0:0] tmpOE__vpp_distance_net;
	wire [0:0] tmpFB_0__vpp_distance_net;
	wire [0:0] tmpIO_0__vpp_distance_net;
	wire [0:0] tmpINTERRUPT_0__vpp_distance_net;
	electrical [0:0] tmpSIOVREF__vpp_distance_net;

	cy_psoc3_pins_v1_10
		#(.id("253dc6ac-65c0-41cc-80d1-db31d725a262"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vpp_distance
		 (.oe(tmpOE__vpp_distance_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vpp_distance_net[0:0]}),
		  .io({tmpIO_0__vpp_distance_net[0:0]}),
		  .siovref(tmpSIOVREF__vpp_distance_net),
		  .interrupt({tmpINTERRUPT_0__vpp_distance_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vpp_distance_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a53bc6c3-64c8-4074-a1e3-a68e550bbda2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ccb1b5ae-f60a-4a31-a1f3-8702e833e9df"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__vpp_distance_1_net;
	wire [0:0] tmpFB_0__vpp_distance_1_net;
	wire [0:0] tmpIO_0__vpp_distance_1_net;
	wire [0:0] tmpINTERRUPT_0__vpp_distance_1_net;
	electrical [0:0] tmpSIOVREF__vpp_distance_1_net;

	cy_psoc3_pins_v1_10
		#(.id("a925b9d1-9f13-403f-9ae4-2afae344c2d9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vpp_distance_1
		 (.oe(tmpOE__vpp_distance_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__vpp_distance_1_net[0:0]}),
		  .io({tmpIO_0__vpp_distance_1_net[0:0]}),
		  .siovref(tmpSIOVREF__vpp_distance_1_net),
		  .interrupt({tmpINTERRUPT_0__vpp_distance_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__vpp_distance_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
